<div class="leftbar">
    ...
    <div class="sidebar">
        <!-- Start Logobar -->
        <div class="logobar">
            <a href="index.html" class="logo logo-large"><img src="/backend/assets/images/logo.svg" class="img-fluid"
                    alt="logo"></a>
            <a href="index.html" class="logo logo-small"><img src="/backend/assets/images/small_logo.svg"
        ...
        <div class="navigationbar">
            <ul class="vertical-menu">
                <li>
                    <a href="{{ route('home') }}">
                        <img src="/backend/assets/images/svg-icon/dashboard.svg" class="img-fluid"
                            alt="dashboard"><span>Dashboard</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('homepage-setting') }}">
                        <img src="/backend/assets/images/svg-icon/basic.svg" class="img-fluid"
                            alt="dashboard"><span>Home Page Setting</span>
                    </a>
                </li>
                <li>
                    <a href="javaScript:void();">
                        <img src="/backend/assets/images/svg-icon/basic.svg" class="img-fluid"
                            alt="basic"><span>Basic UI</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="/backend/assets/images/svg-icon/advanced.svg" class="img-fluid"
                            alt="advanced"><span>Advanced UI</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="/backend/assets/images/svg-icon/apps.svg" class="img-fluid"
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="/backend/assets/images/svg-icon/form_elements.svg" class="img-fluid"
                            alt="form_elements"><span>Forms</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="/backend/assets/images/svg-icon/chart.svg" class="img-fluid"
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="/backend/assets/images/svg-icon/icons.svg" class="img-fluid"
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="/backend/assets/images/svg-icon/tables.svg" class="img-fluid"
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="/backend/assets/images/svg-icon/maps.svg" class="img-fluid"
                ...
                <li>
                    <a href="widgets.html">
                        <img src="/backend/assets/images/svg-icon/widgets.svg" class="img-fluid"
                            alt="widgets"><span>Widgets</span><span class="badge badge-success pull-right">New</span>
                    </a>
                </li>
                <li>
                    <a href="javaScript:void();">
                        <img src="/backend/assets/images/svg-icon/pages.svg" class="img-fluid"
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="/backend/assets/images/svg-icon/ecommerce.svg" class="img-fluid"
                            alt="ecommerce"><span>eCommerce</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
